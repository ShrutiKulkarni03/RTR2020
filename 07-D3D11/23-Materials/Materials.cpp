...
HRESULT Initialize(void)
{
	...
	else
	{
		...
		const char* pixelShaderSourceCode =
			...
			"		float3 specular = (float3)(lS * kS) * pow(max(dot(reflection_vector, normalized_view_vector), 0.0), materialShininess);\n" \
			"		phong_ads_light = (float3)(ambient + diffuse + specular);\n" \
			"	}\n" \
			"	else \n" \
			"	{\n" \
...
void Display(void)
{
	...
	if (bLight == true)
	{
		...
		if (KeyPressed == 1)
			constantBuffer.LightPosition = XMVectorSet(0.0f, r * sin(AngleForXRotation), r * cos(AngleForXRotation), 1.0f);
		
		else if (KeyPressed == 2)
			constantBuffer.LightPosition = XMVectorSet(r * sin(AngleForYRotation), 0.0f, r * cos(AngleForYRotation), 1.0f);

		else if (KeyPressed == 3)
			constantBuffer.LightPosition = XMVectorSet(r * sin(AngleForZRotation), r * cos(AngleForZRotation), 0.0f, 1.0f);
	...
	{
		fopen_s(&gpFile, "RenderLog.txt", "a+");
		fprintf(gpFile, ("else successful\n\n"));
		fclose(gpFile);
...
void drawSpheres(void)
{
	...
	float sphereScale = 1.3f;

	//set perspective matrix again once
	gPerspectiveProjectionMatrix = XMMatrixPerspectiveFovLH(XMConvertToRadians(45.0f), ((float)gWidth / 6) / ((float)gHeight / 4), 0.1f, 100.0f);
	...
	constantBuffer.MaterialShininess = 0.6 * 128;
	...
	d3d11ViewPort.TopLeftX = 0;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	d3d11ViewPort.MaxDepth = 1.0f;
	gpID3D11DeviceContext->RSSetViewports(1, &d3d11ViewPort);
	...
	worldMatrix = XMMatrixScaling(sphereScale, sphereScale, sphereScale) * XMMatrixTranslation(0.0f, 0.0f, 3.0f);

	//cosntant buffers of transformations
	...
	constantBuffer.MaterialShininess = 0.1 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = gWidth / 6;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	...
	constantBuffer.MaterialShininess = 0.3 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = gWidth / 3;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	...
	constantBuffer.MaterialShininess = 0.088 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = gWidth / 2;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	...
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = 2 * gWidth / 3;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	...
	//material buffers
	constantBuffer.KA = XMVectorSet(0.1f, 0.18725f, 0.1745f, 1.0f);
	constantBuffer.KD = XMVectorSet(0.396f, 0.74151f, 0.69102f, 1.0f);
	constantBuffer.KS = XMVectorSet(0.297254f, 0.30829f, 0.306678f, 1.0f);
	constantBuffer.MaterialShininess = 0.1 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = 5 * gWidth / 6;
	d3d11ViewPort.TopLeftY = 0;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	...
	constantBuffer.MaterialShininess = 0.21794872 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = 0;
	d3d11ViewPort.TopLeftY = gHeight / 4;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	d3d11ViewPort.MaxDepth = 1.0f;
	...
	//material buffers
	constantBuffer.KA = XMVectorSet(0.0215f, 0.1275f, 0.054f, 1.0f);
	...
	constantBuffer.MaterialShininess = 0.2 * 128;
	...
	constantBuffer.MaterialShininess = 0.4 * 128;
	...
	constantBuffer.MaterialShininess = 0.25 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = 0;
	d3d11ViewPort.TopLeftY = gHeight / 2;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	d3d11ViewPort.MaxDepth = 1.0f;
	...
	constantBuffer.MaterialShininess = 0.078125 * 128;

	//viewport
	d3d11ViewPort;
	ZeroMemory((void*)&d3d11ViewPort, sizeof(D3D11_VIEWPORT));
	d3d11ViewPort.TopLeftX = 0;
	d3d11ViewPort.TopLeftY = 3 * gHeight / 4;
	d3d11ViewPort.Width = (float)gWidth / 6;
	d3d11ViewPort.Height = (float)gHeight / 4;
	d3d11ViewPort.MinDepth = 0.0f;
	d3d11ViewPort.MaxDepth = 1.0f;
