...
void Display(void)
{
	...
	//transformations
	XMMATRIX XMMatrixTranslationMatrix = XMMatrixTranslation(0.0f, 0.0f, 4.0f);
	XMMATRIX XMMatrixRotationMatrix = XMMatrixRotationY(angleTriangle);
	XMMATRIX worldMatrix = XMMatrixRotationMatrix * XMMatrixTranslationMatrix;
