...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void draw()
	{
		...
		//push
		stackMatrix.push(modelViewMatrix);
		...
		GLES32.glVertexAttrib3f(GLESMacros.SPK_ATTRIBUTE_COLOR, 1.0f, 0.5f, 0.0f);
		...
		//pop
		modelViewMatrix = stackMatrix.pop();
		stackMatrix.push(modelViewMatrix);

		//
		Matrix.rotateM(modelViewMatrix, 0, (float)year, 0.0f, 1.0f, 0.0f);
		Matrix.translateM(modelViewMatrix, 0, 1.5f, 0.0f, 0.0f);
		Matrix.scaleM(modelViewMatrix, 0, 0.6f, 0.6f, 0.6f);
		Matrix.rotateM(modelViewMatrix, 0, 90.0f, 1.0f, 0.0f, 0.0f);

		stackMatrix.push(modelViewMatrix);

		Matrix.rotateM(modelViewMatrix, 0, (float)day, 0.0f, 0.0f, 1.0f);

		Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, modelViewMatrix, 0);
		GLES32.glUniformMatrix4fv(mvpUniform, 1, false, modelViewProjectionMatrix, 0);

		GLES32.glVertexAttrib3f(GLESMacros.SPK_ATTRIBUTE_COLOR, 0.4f, 0.9f, 1.0f);
		...
		//
		Matrix.rotateM(modelViewMatrix, 0, (float)day, 0.0f, 0.0f, 1.0f);
		Matrix.translateM(modelViewMatrix, 0, 1.2f, 0.0f, 0.0f);
		Matrix.scaleM(modelViewMatrix, 0, 0.5f, 0.5f, 0.5f);
		Matrix.rotateM(modelViewMatrix, 0, (float)hour, 0.0f, 0.0f, 1.0f);
