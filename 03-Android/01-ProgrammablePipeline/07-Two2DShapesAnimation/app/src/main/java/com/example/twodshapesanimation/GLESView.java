package com.example.twodshapesanimation;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		colorBufferTriangle.put(triangleColor);
		colorBufferTriangle.position(0);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, triangleColor.length * 4, colorBufferTriangle, GLES32.GL_STATIC_DRAW);
		...
		ByteBuffer byteBufferColorQuad = ByteBuffer.allocateDirect(quadColor.length * 4);
		byteBufferColorQuad.order(ByteOrder.nativeOrder());
		FloatBuffer colorBufferQuad = byteBufferColorQuad.asFloatBuffer();
		colorBufferQuad.put(quadColor);
		colorBufferQuad.position(0);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, quadColor.length * 4, colorBufferQuad, GLES32.GL_STATIC_DRAW);
		GLES32.glVertexAttribPointer(GLESMacros.SPK_ATTRIBUTE_COLOR, 3, GLES32.GL_FLOAT, false, 0, 0);
		GLES32.glEnableVertexAttribArray(GLESMacros.SPK_ATTRIBUTE_COLOR);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
	...
	private void draw()
	{
		...
		Matrix.rotateM(rotateMatrix, 0, triangleAngle, 0.0f, 1.0f, 0.0f);
		...
		Matrix.translateM(translateMatrix, 0, 2.0f, 0.0f, -6.0f);
		Matrix.rotateM(rotateMatrix, 0, quadAngle, 1.0f, 0.0f, 0.0f);
