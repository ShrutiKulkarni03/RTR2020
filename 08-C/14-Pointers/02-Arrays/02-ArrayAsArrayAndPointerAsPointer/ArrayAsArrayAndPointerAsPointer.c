...
int main(void)
{
	...
	int iArray[] = { 03,6,9,12,15,18,21,24,27,30 };
	int* ptr_iArray = NULL;

	//code
	printf("\n\nUsing Array Name as Array i.e. : Value of X Element of iArray : iArray[X] and Address of X Elements of iArray : &iArray[X]\n\n");
	printf("Integer Array Elemnts and their Addresses : \n\n");
	...
	printf("\n\nUsing Pointer as Pointer i.e. : Value of X Element odf iArray : *(ptr_iArray + X) and Address of X Element of iArray : (ptr_iArray + X)\n\n");
