...
void Display(void)
{
	...
	gluSphere(quadric, 0.75f, 20, 20);  //sun
	...
	gluSphere(quadric, 0.2f, 10, 10); //earth
	...
	glRotatef((GLfloat)hour, 0.0f, 0.0f, 1.0f);   //axis changed
	...
	gluSphere(quadric, 0.1f, 10, 10); //moon
